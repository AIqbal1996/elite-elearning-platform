...
export async function loadLearningData() {
  const [stats, courses, learningPaths, assessments, pilots, pythonSyllabus, sqlSyllabus] = await Promise.all([
    getJson('stats.json'),
  ...
  return { stats, courses, learningPaths, assessments, pilots, pythonSyllabus, sqlSyllabus };
}
